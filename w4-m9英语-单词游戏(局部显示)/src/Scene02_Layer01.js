var Scene02_Layer01 = MyLayer.extend({
  ctor: function (num) {
    this._super()
  ...
  onEnter: function(){
    ...
    this.sprites(Scene02_spr_data[1])
    this.dragArr = []
      ...
      onTouchEnded: function(touch, event){
        ...
        if(target.id === 1010){
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).initWithFile(res.gui01)
            target.runAction(cc.sequence(
              ...
              cc.callFunc(function(){
                ...
                this.getChildByTag(1012).setOpacity(255)
                this.getChildByTag(1013).runAction(cc.fadeIn(1.5, 255))
                this.right()
                this.scheduleOnce(function(){
                  this.getParent().move = false
                  this.getParent().getChildByTag(this.num).setOpacity(0)
                  this.getParent().okArr.push(0)
          ...
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).frameAnimate([res.gui02, res.gui03], 0.5, 2)
            target.crashed = true
            target.setOpacity(0)
          }else{
            target.runAction(cc.sequence(
