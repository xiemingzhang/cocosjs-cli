var Scene01_Layer03 = MyLayer.extend({
  ctor: function (num) {
    this._super()
  ...
  onEnter: function(){
    ...
    this.sprites(Scene01_spr_data[3])
    this.dragArr = []
      ...
      onTouchEnded: function(touch, event){
        ...
        if(target.id === 1010){
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).initWithFile(res.niao01)
          ...
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).frameAnimate([res.niao02, res.niao03], 0.5, 1)
            target.crashed = true
            target.setOpacity(0)
          }else{
            target.runAction(cc.sequence(
