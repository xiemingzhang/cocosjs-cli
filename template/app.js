...
// var recordResult = function (obj) {
//     if(obj){
//       upRecord.push({page: 111, src: obj});
//       myScene.nextLayer();
//     }
// }
var screenshotsResult = function (obj) {
    // App.screenshotsResult(obj)
    screenImg.data[0][1] = obj;
    ...
    screenImg = {
      ...
      data: [[1, '']]// 为了后台数据统一才设成二维数组,内部数组的第一项是页数，第二项是图片路径
    }
}
// var takePhotoResult = function (obj) {
//     App.takePhotoResult(obj)
// }
