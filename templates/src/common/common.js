...
var StarLayer = cc.Layer.extend({
  ...
  gameEnd: function (num) {// 完成游戏提示 +退出
    ...
    if(num === 1){
      ...
      var pos = [
        {
          ...
          x: size.width / 2 + scoreWidth * 2 + 8 * 2 - 4,
          y: size.height / 414 * 134
        }]
    }else if(num === 5){
      pos = [
      ...
      pos = [
        {
          ...
          x: size.width / 2 + scoreWidth * 3 + 8 * 3 - 4,
          y: size.height / 414 * 134
        }]
    }else if(num === 7){
      pos = [
      ...
      pos = [
        ...
        },
        {
          ...
          x: size.width / 2 + scoreWidth * 4 + 8 * 4 - 4,
          y: size.height / 414 * 134
        }]
    }else if(num === 9){
      pos = [
      ...
      pos = [
        ...
        },
        {
          ...
          x: size.width / 2 + scoreWidth * 5 + 8 * 5 - 4,
          y: size.height / 414 * 134
        }]
    }else if(num === 12){
      pos = [
        {
          x: size.width / 2 - scoreWidth * 5 - 4 * 5 - 2,
          y: size.height / 414 * 134
        },
        {
          x: size.width / 2 - scoreWidth * 4 - 4 * 4 - 2,
          y: size.height / 414 * 134
        },
        {
          x: size.width / 2 - scoreWidth * 3 - 4 * 3 - 2,
          y: size.height / 414 * 134
        },
        {
          x: size.width / 2 - scoreWidth * 2 - 4 * 2 - 2,
          y: size.height / 414 * 134
        }, {
          x: size.width / 2 - scoreWidth - 4 - 2,
          y: size.height / 414 * 134
        }, {
          x: size.width / 2 - 2,
          y: size.height / 414 * 134
        }, {
          x: size.width / 2 + scoreWidth + 2,
          y: size.height / 414 * 134
        }, {
          x: size.width / 2 + scoreWidth * 2 + 4 * 2 - 2,
          y: size.height / 414 * 134
          ...
          x: size.width / 2 + scoreWidth * 6 + 4 * 6 - 2,
          y: size.height / 414 * 134
        }]
    }
    ...
    for(var n = 0;n < this.starArr.length;n++){
      ...
      var action2 = cc.callFunc(function(){sound.buttonAudio()})
