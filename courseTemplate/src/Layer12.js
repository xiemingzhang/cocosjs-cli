var Layer12 = MyLayer.extend({
  ...
  onStart: function() {
    ...
    var left = new cc.ProgressTimer(new cc.Sprite(res.chi81))
    ...
    this.scheduleOnce(function(){
      sprs[3].frame([res.frog3, res.frog4], 0.5, 0)
    }, 1)
    ...
    this.scheduleOnce(function(){
      sprs[4].frame([res.frog3, res.frog4], 0.5, 0)
    }, 1.5)
