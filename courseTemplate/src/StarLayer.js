...
var StarLayer = cc.Layer.extend({
  ...
  starNum: function (num) {// 初始星星
    ...
    var h1 = (size.height - 52 * fix * 1920/736)
    var h2 = (size.height - 47 * fix * 1920/736)
    this.shape = []
    this.backSprite = cc.Sprite.create(res.Back)
    this.backSprite.id = 'back'
    this.backSprite.setAnchorPoint(0, 0)
    this.backSprite.setPosition(16 * 3, h1)
    this.backSprite.setScale(0.25 * fix * 1920/736)
    this.addChild(this.backSprite, 105)
    var jianju = 36 * 1920/736
    var chushi = 692 * 1920/736
    var weizhi = 0
    for (var i = num.total; i >= 1; i--) {
      ...
      this.shape[i].setScale(0.333 * fix * 1920/736)
      this.addChild(this.shape[i], 3)
    }
  },
  rightStar: function (count) {// 飞星效果
    updata.finish_star++
    var randX = this.random(100 * fix * 1920/736, 400 * fix * 1920/736)
    /* 出现飞星*/
    this.star = cc.Sprite.create(res.FlyStar)
    this.star.setAnchorPoint(0, 0)
    this.star.setPosition(randX, -150)
    this.star.setScale(0.2 * 1920/736)
    this.addChild(this.star, 10)
    /* 动画 贝塞尔*/
    var array = [
      cc.p(randX, 0),
      cc.p(randX + 80 * fix, 110 * 1920/736),
      cc.p(randX + 160 * fix, 220 * 1920/736),
    ...
    /* 星星缩放*/
    var scale1 = cc.scaleTo(0.4, 0.25 * 1920/736)
    var scale2 = cc.scaleTo(0.4, 0.04 * 1920/736)
    /* 依次执行*/
  ...
  wrongStar: function () {// 错误的星星效果
    if (this.flag) {
      ...
      this.wStar.setScale(0.16 * 1920/736)
      this.addChild(this.wStar, 10)

      var action1 = cc.moveBy(0.5, 0, 200 * 1920/736)
      var move_ease1 = action1.easing(cc.easeOut(2))

      var action2 = cc.moveBy(0.5, 0, -200 * 1920/736)
      ...
      var action3 = cc.moveTo(0.3, this.wStar.x, 20 * 1920/736)
  ...
  gameEnd: function (num) {
    ...
    board.setScale(1 / 3 * fix * 1920/736)
    board.setPosition(368 * fix * 1920/736, (80 * fix + 180 / fix - 180) * 1920/736)
    this.addChild(board, 101)

    this.text_great = new cc.LabelTTF('小朋友你真棒！', 'STYuanti-TC-Regular', 18 * 1920/736)
    this.text_great.setAnchorPoint(0.5, 0)
    this.text_great.setPosition(368 * fix * 1920/736, (231 * fix + 180 / fix - 180) * 1920/736)
    this.text_great.setColor(cc.color(79, 53, 48))
    this.addChild(this.text_great, 101)

    this.text_x = new cc.LabelTTF('x', 'STYuanti-TC-Regular', 32 * 1920/736)
    this.text_x.setAnchorPoint(0, 0)
    this.text_x.setPosition(363 * fix * 1920/736, (162 * fix + 160 / fix - 160) * 1920/736)
    this.text_x.setColor(cc.color(79, 53, 48))
    this.addChild(this.text_x, 101)

    this.text_num = new cc.LabelTTF(num, 'STYuanti-TC-Regular', 44 * 1920/736)
    this.text_num.setAnchorPoint(0, 0)
    this.text_num.setPosition(392 * fix * 1920/736, (152 * fix + 160 / fix - 160) * 1920/736)
    ...
    this.star_finish.setScale(1 / 3 * fix * 1920/736)
    this.star_finish.setPosition(351 * fix * 1920/736, (153 * fix + 180 / fix - 180) * 1920/736)
    this.addChild(this.star_finish, 101)

    this.btn_rePlay = new cc.Sprite(res.button_green)
    this.btn_rePlay.setAnchorPoint(1, 0)
    this.btn_rePlay.setScale(1 / 3 * fix * 1920/736)
    this.btn_rePlay.setPosition(348 * fix * 1920/736, (55 * fix + 180 / fix - 180) * 1920/736)
    this.addChild(this.btn_rePlay, 101)

    this.btn_next = new cc.Sprite(res.button_next)
    this.btn_next.setAnchorPoint(0, 0)
    this.btn_next.setScale(1 / 3 * fix * 1920/736)
    this.btn_next.setPosition(388 * fix * 1920/736, (55 * fix + 180 / fix - 180) * 1920/736)
