var Scene02_Layer02 = MyLayer.extend({
  ctor: function (num) {
    this._super()
  ...
  onEnter: function(){
    ...
    this.sprites(Scene02_spr_data[2])
    this.dragArr = []
      ...
      onTouchEnded: function(touch, event){
        ...
        if(target.id === 1010){
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).initWithFile(res.mao01)
          ...
          if(this.crash(target, this.getChildByTag(1000))){
            ...
            this.getChildByTag(1000).frameAnimate([res.mao02, res.mao03], 0.5, 1)
            target.crashed = true
            target.setOpacity(0)
          }else{
            target.runAction(cc.sequence(
